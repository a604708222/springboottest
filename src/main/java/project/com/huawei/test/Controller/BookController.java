...
public class BookController {
    ...
    private void test10() {
        ...
        Integer count = jdbcTemplate.queryForObject("select count(*) from t_book t where t.name like ?", Integer.class,
                new Object[] { "%shu%" });
        ...
        List<Map<String, Object>> list = jdbcTemplate.queryForList("select * from t_book t where t.name like ?",
                new Object[] { "%shu%" });
        list.forEach(System.out::println);
        ...
        Map<String, Object> m = jdbcTemplate.queryForMap("select * from t_book t where t.name like ?",
                new Object[] { "%shu3%" });
